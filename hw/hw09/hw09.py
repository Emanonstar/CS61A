...
def in_order_traversal(t):
    ...
    if t.is_leaf():
        ...
        for n in in_order_traversal(t.branches[0]):
            yield n
        yield t.label
        for n in in_order_traversal(t.branches[1]):
            yield n
...
def interleaved_sum(n, odd_term, even_term):
    ...
    def helper(i,is_even):
        if i == n:
            return term[is_even](i)
        return term[is_even](i) + helper(i+1, 1-is_even)
    return helper(1,0)
