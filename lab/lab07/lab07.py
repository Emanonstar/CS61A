...
def subseqs(s):
    ...
    if s == []:
        ...
        item, nested_list = s.pop(0), subseqs(s)
        return insert_into_all(item, nested_list) + nested_list
...
def make_glookup(class_assignments):
    ...
    0.8913043478260869
    """
    total_grade, got_grade = 0, 0
    def student(part, score):
        nonlocal total_grade, got_grade
        got_grade += score
        total_grade += class_assignments[part]
        return got_grade / total_grade
    return student
